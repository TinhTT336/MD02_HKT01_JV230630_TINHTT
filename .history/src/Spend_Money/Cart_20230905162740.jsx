                            ...
                            <div className="pointer-events-auto w-screen max-w-md">
                                <div className="flex h-full flex-col overflow-y-scroll bg-white shadow-xl">
                                                            ...
                                                            <div className="ml-4 flex flex-1 flex-col">
                                                                <div>
                                                                    <div className="flex justify-between text-base font-medium text-gray-900">
                                                                        ...
                                                                        <p className="text-gray-500"> <button onClick={() => handleDecrease(pro.id)} style={{ width: 20, border: "1px solid #000", textAlign: "center" }} >-</button> {pro.quantity}<button style={{ width: 20, border: "1px solid #000", textAlign: "center" }} value="+">+</button></p>
                                                                    </div>
                                                                </div>
                                    ...
                                    <div className="border-t border-gray-200 px-4 py-6 sm:px-6">
                                        <div className="flex justify-between text-base font-medium text-gray-900">
                                            <p>Subtotal</p>
                                            {/* <p>{productList.reduce((total, p) => { return total += (p.quantity * p.price) }, 0)}</p> */}
                                        </div>
