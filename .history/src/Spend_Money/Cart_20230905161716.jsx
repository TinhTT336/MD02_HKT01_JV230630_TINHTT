                                                            ...
                                                            <div className="ml-4 flex flex-1 flex-col">
                                                                <div>
                                                                    <div className="flex justify-between text-base font-medium text-gray-900">
                                                                        ...
                                                                        <p className="text-gray-500"> <input style={{ width: 20, border: "1px solid #000", textAlign: "center" }} value="-"></input> {pro.quantity}<input style={{ width: 20, border: "1px solid #000", textAlign: "center" }} value="+"></input></p>
                                                                    </div>
                                                                </div>
